...
SearchResultClass.prototype.getSearchResult = function(arguments , callback) {
    ...
    if (this.searchType == "Regular") {
        ...
        '/searchservices.php?name=searchresults&category=' + args.catId + '&subcategory=' + args.subCatId + '&mincapital=' + args.lowInvestment + '&maxcapital=' + args.highInvestment + '&statecode=' + args.location;        
    } else if (this.searchType == "A-Z") {
        searchURL = ((Titanium.App.deployType=='production')?Ti.App.Properties.getString('Server'):Ti.App.Properties.getString('Server-Dev')) + 
        '/searchservices.php?name=searchresults&type=a2z';
    } else if (this.searchType == "Keyword") {
        searchURL = ((Titanium.App.deployType=='production')?Ti.App.Properties.getString('Server'):Ti.App.Properties.getString('Server-Dev')) + 
        '/searchservices.php?name=searchresults&keyword='+ args.keyword;
        ...
        earchURL = ((Titanium.App.deployType=='production')?Ti.App.Properties.getString('Server'):Ti.App.Properties.getString('Server-Dev')) + 
            '/searchservices.php?name=searchresults&type=workfromhome';
    } else if (this.searchType == "LowCost") {
        searchURL = ((Titanium.App.deployType=='production')?Ti.App.Properties.getString('Server'):Ti.App.Properties.getString('Server-Dev')) + 
        '/searchservices.php?name=searchresults' + '&mincapital=' + args.lowInvestment + '&maxcapital=' + args.highInvestment;
        ...
        searchURL = ((Titanium.App.deployType=='production')?Ti.App.Properties.getString('Server'):Ti.App.Properties.getString('Server-Dev')) + 
        '/searchservices.php?name=searchresults&bigops=yes';
    } else if (this.searchType == "Top25") {
        searchURL = ((Titanium.App.deployType=='production')?Ti.App.Properties.getString('Server'):Ti.App.Properties.getString('Server-Dev')) + 
        '/searchservices.php?name=searchresults&top25=yes';
